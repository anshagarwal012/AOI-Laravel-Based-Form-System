        ...
        <div class="card-inner card-inner-lg">
            ...
            <form action="{{ route('form_submit') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="form-control-wrap">
                        <input type="text" class="form-control" name="Tittle_Presentation" placeholder="Enter Presentation">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-auto">
                            <div class="custom-control custom-radio">
                                <input type="radio" value="Oral" class="custom-control-input" id="customCheck7Oral" name="model">
                                <label class="custom-control-label" for="customCheck7Oral">Oral</label>
                            </div>
                        </div>
                        <div class="col-auto">
                            <div class="custom-control custom-radio">
                                <input type="radio" value="Poster" class="custom-control-input" id="customCheck7Poster" name="model">
