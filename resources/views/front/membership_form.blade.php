            ...
            <form action="{{ route('form_submit') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-10 pl-0">
                            <div class="form-control-wrap">
                                <input type="text" class="form-control" name="AccompanyingPersonsProfessionname1" placeholder="Name">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8 pl-0">
                            <div class="form-control-wrap">
                                <input type="text" class="form-control" name="institution_name" placeholder="Enter Name">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-control-wrap">
                            <input type="text" class="form-control" name="others" placeholder="Enter Information">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="form-label">Telephone</label>
                        <div class="form-control-wrap">
                            <input type="phone" class="form-control" name="Telephone" placeholder="Enter Telephone">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-control-wrap">
                            <input type="phone" class="form-control" name="MobileNumber" placeholder="Enter Mobile Number">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-control-wrap">
                            <input type="text" class="form-control" name="AOIMembershipNumber" placeholder="Enter AOI Membership Number">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-10 pl-0">
                                <div class="form-control-wrap">
                                    <input type="text" class="form-control" name="Accompanying_1" placeholder="Enter Accompanying Persons 1">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-md-10 pl-0">
                                <div class="form-control-wrap">
                                    <input type="text" class="form-control" name="Accompanying_2" placeholder="Enter Accompanying Persons 2">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-control-wrap">
                            <input type="text" class="form-control" name="DraftChequeNo" placeholder="Enter Draft/Cheque No.">
                        </div>
                    </div>
                    <div class="form-group">
